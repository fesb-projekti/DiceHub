...
app.get("/profileCards/profile/:username", (req, res) => {
    ...
    const sqlSelect = "SELECT ime,prezime,grad,about,age,hasLocation,img FROM korisnik LEFT JOIN inventar ON korisnik.ID = inventar.korisnikID LEFT JOIN igre ON inventar.igraID = igre.ID WHERE korisnik.username = ? LIMIT 1";
