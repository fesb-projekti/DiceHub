...
import {useRef,useCallback,useLayoutEffect,createElement,forwardRef,useImperativeHandle} from "react";

const SwipeCard = forwardRef(({ flickOnSwipe = true, children, onSwipe, onCardLeftScreen, className, preventSwipe = [] }, ref) => {
  ...
  const element = useRef()
    ...
    const handleSwipeReleased = useCallback(async (element, speed) => {
